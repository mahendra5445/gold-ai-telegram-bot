...
def get_all_trades() -> list[dict]:
    """Saare trades (open + closed) — guards aur analytics ke liye."""
    return list(_trades)
...
def get_stats(asset: str | None = None, since: str | None = None) -> dict:
    ...
    # Expectancy / profit factor / drawdown / streaks.
    # analytics.py ka R-model documented hai — asli P&L nahi, ek
    # consistent yardstick hai settings compare karne ke liye.
